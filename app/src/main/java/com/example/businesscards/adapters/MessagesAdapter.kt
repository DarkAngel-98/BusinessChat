...
class MessagesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return if(viewType == layoutRightID){
            var view: View =
                LayoutInflater.from(parent.context).inflate(R.layout.chat_right_item_layout, parent, false)
            ViewHolder(view)
        } else{
            var view: View =
                LayoutInflater.from(parent.context).inflate(R.layout.chat_left_item_layout, parent, false)
            ViewHolder(view)
        }
    }
...
//            }
//        }
//        else if(getItemViewType(position) == R.layout.chat_left_item_layout){
...
//        }
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        return if(chats[position].senderId.equals(firebaseUser?.uid))
            layoutRightID
        else
            layoutLeftID
    }
